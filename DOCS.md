...
├── aur_helper               # Preferred AUR helper (new in v0.8.0)
...
├── restic/                  # Restic repository cache (new in v0.8.0)
...
ghostctl arch aur            # AUR helper management (enhanced in v0.8.0)
ghostctl nvidia menu         # NVIDIA management
ghostctl dev menu            # Development environment
ghostctl proxmox menu        # Enhanced Proxmox VE tools (new in v0.8.0)
ghostctl restic menu         # Restic CLI tools (new in v0.8.0)
